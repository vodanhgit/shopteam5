						...
						<li>
							<div class="row">
								<c:forEach var="item" items="${items}">
									<form action="/chitietsanpham/${item.maSanPham}" method="post">
									<input type="hidden" value="${item.maSanPham}" name="msp">
									<div class="col-md-4 col-sm-6">
										<div class="products">
											<div class="thumbnail">
												<a href=""> <img
													src="images/products/large/${item.hinhAnh}" alt="Product Name"
													style="height: 90%;">
												</a>
											</div>
											<div class="productname" style="display: none;"></div>
											<div class="productname">${item.tenSanPham}</div>
											<h4 class="price"><fmt:formatNumber value="${item.gia}"
													currencySymbol="VNĐ" type="currency" /></h4>
											<h4 class="price" style="text-decoration: line-through; color: gray;"><fmt:formatNumber value="${item.giaGoc}"
													currencySymbol="VNĐ" type="currency" /></h4>
						...
						navigation example">
								<ul class="pagination">
									<c:forEach var="i" begin="0" end="${page.totalPages +1}">
										<a class="page-link" href="/index?n=${i}">${i+1} </a>
									</c:forEach>
								</ul>
							</nav>
