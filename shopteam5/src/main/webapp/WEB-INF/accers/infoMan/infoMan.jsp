...
<body>
				...
				<table class="table table-bordered table-hover">
					...
					<tbody>
						<c:forEach var="hd" items="${hds}">
							<c:forEach var="hoaDonChiTiet" items="${hd.hoaDonChiTiets}">
								<tr>
									<td>${hoaDonChiTiet.maHoaDonChiTiet}</td>
									<td>${hd.tenNguoiMua}</td>
									<td>${hd.diaChi}</td>
									<td>${hoaDonChiTiet.sanPham2.tenSanPham}</td>
									<td>${hoaDonChiTiet.mau}</td>
									<td>${hoaDonChiTiet.size}</td>
									<td><span style="color: red;"><fmt:formatNumber
												value="${hoaDonChiTiet.donGia}" currencySymbol="VNĐ"
												type="currency" /></span></td>
									<td>${hoaDonChiTiet.soLuong}</td>
									<td>${hoaDonChiTiet.thanhTien}</td>
									<td><strong>${hd.trangThai}</strong></td>
  ...
  <path fill-rule="evenodd"
						...
						<li class="page-item"><a class="page-link"
							href="/infoMan?f=${pagehd.number-1}"><svg
  ...
  <path fill-rule="evenodd"
						...
						<li class="page-item"><a class="page-link"
							href="/infoMan?f=${pagehd.totalPages-1}"><svg
									xmlns="http://www.w3.org/2000/svg" width="12" height="12"
