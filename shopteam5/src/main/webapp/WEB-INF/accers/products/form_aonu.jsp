              ...
              <div class="row">
                <div class="col-md-4 col-sm-6">
                  <div class="products">
                    <div class="thumbnail">
                      <a href="details.html">
                        <img src="images/products/male/1.png" alt="Product Name" style="height: 90%;">
                      </a>
                    </div>
                ...
                <div class="col-md-4 col-sm-6">
                  <div class="products">
                    <div class="thumbnail">
                      <a href="details.html">
                        <img src="images/products/male/2.png" alt="Product Name" style="height: 90%;">
                      </a>
                    </div>
                    <div class="productname">
                     Áo sơ mi nữ
                ...
                <div class="col-md-4 col-sm-6">
                  <div class="products">
                    ...
                    <div class="thumbnail">
                      <a href="details.html">
                        <img src="images/products/male/4.jpeg" alt="Product Name" style="height: 90%;">
                      </a>
                    </div>
                    <div class="productname">
                     Áo len nữ
                ...
                <div class="col-md-4 col-sm-6">
                  <div class="products">
                    <div class="thumbnail">
                      <a href="details.html">
                        <img src="images/products/male/3.png" alt="Product Name" style="height: 90%;">
                      </a>
                    </div>
                    <div class="productname">
                     Áo Bra
