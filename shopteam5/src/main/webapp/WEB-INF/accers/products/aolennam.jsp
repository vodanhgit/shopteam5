...
<title>Áo Len Nam - ShopTeam5</title>
					...
					<div class="col-md-9">
						...
						<div class="products-grid">
							...
							<div class="row">
								...
								<c:forEach var="aolennam" items="${aolennam}">
									<div class="col-md-4 col-sm-6">
										<div class="products">
											<div class="thumbnail">
												<a href="details.html"> <img
													src="images/products/large/${aolennam.hinhAnh}" alt="Product Name"
													style="height: 90%;">
												</a>
											</div>
											<div class="productname" style="display: none;"></div>
											<div class="productname">${aolennam.tenSanPham}</div>
											<h4 class="price">${aolennam.gia}VND</h4>
