					...
					<div class="col-md-9">
						...
						<div class="products-grid">
							...
							<div class="row">
								...
								<c:forEach var="aobra" items="${aobra}">
									<div class="col-md-4 col-sm-6">
										<div class="products">
											<div class="thumbnail">
												<a href="details.html"> <img
													src="images/products/large/${aobra.hinhAnh}"
													alt="Product Name" style="height: 90%;">
												</a>
											</div>
											<div class="productname" style="display: none;"></div>
											<div class="productname">${aobra.tenSanPham}</div>
											<h4 class="price">${aobra.gia}VND</h4>
