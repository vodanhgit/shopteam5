          ...
          <div class="col-md-9">
            <div class="products-details">
              ...
              <div class="products-description">
                ...
                <p>
                 Chiếc áo được làm bằng vải coton. Cổ áo co giãn tiện lợi.
                </p>
                <hr class="border">
                <div class="price">
                  Giá :
                ...
                <div class="wided">
                  <div class="qty">
                    ...
                    <input type="number" size="4" title="Qty" value="1" name="quantity" min="1" max="10" step="1">
                  ...
                  <div class="tab-content" id="Descraption">
                    <p>
                      <div style="font-size: 14px;">
                        <div><strong>Chất liệu:&nbsp;</strong>vải tổng hợp&nbsp;cao cấp</div>
                        <div><strong>Kiểu dáng:&nbsp;</strong>áo vest thiết kế chiết eo, cài khuy bọc phía trước, tone
                          màu
                          hồng trơn<br><strong>Sản phẩm thuộc dòng sản phẩm :&nbsp;</strong>NEM NEW</div>
                        <div><strong>Thông tin người mẫu:&nbsp;</strong>mặc sản phẩm size 2</div>
                        <div><strong>Sản phẩm kết hợp:</strong>chân váy Z16862</div>
                      </div>
                    </p>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-4 col-sm-4">
                    <div class="products">
                      ...
                      <div class="thumbnail"><a href="/mota"><img src="images/products/large/938-9385688_o-s-mi-nam-mu-trng.png"
                            alt="Product Name" style="height: 98%"></a></div>
                      ...
                      <div class="button_group"><button class="button add-cart" type="button">Thêm vào
                          giỏ</button><button class="button compare" type="button"><i
                  ...
                  <div class="col-md-4 col-sm-4">
                    <div class="products">
                      <div class="offer">- %20</div>
                      <div class="thumbnail"><a href="details.html"><img src="images/products/small/products-02.png"
                            alt="Product Name"></a></div>
                      <div class="productname">Đầm Mercerized Cotton Dáng Chữ A</div>
                  ...
                  <div class="col-md-4 col-sm-4">
                    <div class="products">
                      ...
                      <div class="thumbnail"><a href="details.html"><img src="images/products/small/products-03.png"
                            alt="Product Name"></a></div>
                      <div class="productname">Đầm Cotton Mini Xếp Tầng Ngắn Tay</div>
              ...
              <li>
                <div class="row">
                  <div class="col-md-4 col-sm-4">
                    <div class="products">
                      <div class="offer">- %20</div>
                      <div class="thumbnail"><a href="details.html"><img src="images/products/small/products-01.png"
                            alt="Product Name"></a></div>
