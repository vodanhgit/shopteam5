					...
					<div class="col-md-9">
						...
						<div class="products-grid">
							...
							<div class="clearfix"></div>
								<h4>Áo thun Nam</h4>
							<div class="row">
								<c:forEach var="formaonamshow" items="${aothunnam}">
									<form action="/chitietsanpham/${formaonamshow.maSanPham}"
										method="post">
										<input type="hidden" value="${formaonamshow.maSanPham}"
											name="msp">
										<div class="col-md-4 col-sm-6">
											<div class="products">
												<div class="thumbnail">
													<a href="details.html"> <img
														src="images/products/large/${formaonamshow.hinhAnh}"
												...
												<h4 class="price">
													<fmt:formatNumber value="${formaonamshow.gia}"
