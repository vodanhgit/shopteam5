...
<title>Áo Thun Nam - ShopTeam5</title>
                  ...
                  <input type="submit" value="Go">
					...
					<div class="col-md-9">
						...
						<div class="products-grid">
							...
							<div class="clearfix"></div>
							<div class="row">
								<c:forEach var="aothunam" items="${aothunnam}">
									<div class="col-md-4 col-sm-6">
									  <input type="hidden" value="${aothunam.maSanPham}"></input>  --%>
										<div class="products">
											<div class="thumbnail">
												<a href=""> <img
													src="images/products/large/${aothunam.hinhAnh}" alt="Product Name"
													style="height: 90%;">
												</a>
											</div>
											<div class="productname" style="display: none;"></div>
											<div class="productname">${aothunam.tenSanPham}</div>
											<h4 class="price">${aothunam.gia}VND</h4>
											<div class="button_group">
												<button class="button add-cart" type="button"
													formaction="${aothunnan.maSanPham}">Thêm vào giỏ</button>
			<a href="/mota/${aothunnan.maSanPham}">sdđ</a>
											</div>
										</div>
									</div>
