		...
		<div class="container mt-5 border rounded">
			<div class="row">
				<div
					...
					<img alt="exchange" src="images/exchange-svgrepo-com.svg"
						height="45" width="45">
					<div>Exchange</div>
				</div>
				<div
					class="col-2 d-flex justify-content-center align-items-center p-3">
					<img alt="exchange" src="images/free-shipping-svgrepo-com.svg"
						height="45" width="45">
					<div>Free ship</div>
				</div>
				<div
					class="col-2 d-flex justify-content-center align-items-center p-3">
					<img alt="exchange" src="images/award-quality-svgrepo-com.svg"
						height="45" width="45">
					<div>Quality</div>
				</div>
				<div
					class="col-2 d-flex justify-content-center align-items-center p-3">
					<img alt="exchange" src="images/flash-svgrepo-com.svg" height="45"
						width="45">
					<div>Cheap</div>
				</div>
				<div
					class="col-2 d-flex justify-content-center align-items-center p-3">
					<img alt="exchange"
						src="/images/shipping-fast-solid-svgrepo-com.svg" height="45"
						width="45">
				...
				<div
					class="col-2 d-flex justify-content-center align-items-center p-3">
					<img alt="exchange"
						src="images/operator-customer-service-svgrepo-com.svg" height="45"
						width="45">
					<div>CSKH</div>
				</div>
			</div>
