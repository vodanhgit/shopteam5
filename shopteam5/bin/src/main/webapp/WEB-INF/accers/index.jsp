...
<head>
   ...
   <link href="WEB-INF/accers/css/bootstrap.css" rel="stylesheet">
   <link
      href='http://fonts.googleapis.com/css?family=Roboto:400,300,300italic,400italic,500,700,500italic,100italic,100'
      rel='stylesheet' type='text/css'>
   <link href="WEB-INF/accers/css/font-awesome.min.css" rel="stylesheet">
   <link rel="stylesheet" href="/WEB-INF/accers/css/flexslider.css" type="text/css" media="screen" />
   <link href="WEB-INF/accers/css/sequence-looptheme.css" rel="stylesheet" media="all" />
   <link href="WEB-INF/accers/css/style.css" rel="sty@lesheet">
                              ...
                              <div class="dropdown-menu mega-menu">
                                 <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                       <ul class="mega-menu-links">
                                          <li><a href="productgird.html">Áo thun nam</a></li>
         ...
         <div class="container">
            <div id="sequence">
               ...
               <ul class="sequence-canvas">
                  <li class="animate-in">
                     <div class="flat-caption caption1 formLeft delay300 text-center"><span class="suphead">ShopTeam5 Since
                           2023</span></div>
                     <div class="flat-caption caption2 formLeft delay400 text-center">
                        <h1>Bộ sưu tập cho mùa Hè</h1>
                     </div>
                     <div class="flat-caption caption3 formLeft delay500 text-center">
                        <p>Thế giới thời trang.<br>Nơi bắt nguồn của những cảm hứng thời trang</p>
                     </div>
                     ...
                     <div class="flat-image formBottom delay200" data-duration="5" data-bottom="true"><img
                           src="images/Layer 1.png" alt=""></div>
                  </li>
                  <li>
      ...
      <div class="container_fullwidth">
         <div class="container">
            <div class="hot-products">
               <h3 class="title">Sản phẩm <strong>đang hot</strong></h3>
